...
<body>
	...
	<main>
		...
		<section class="hero_in hotels">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Action</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid">
						<figure>
							...
							<a href="hotel-detail.html"><img src="../asset/horor/rasuk.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>action</small>
						</figure>
