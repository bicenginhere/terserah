...
<body>
	...
	<main>
		...
		<section class="hero_in petualang">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Petualangan</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
			...
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid">
						<figure>
							...
							<a href="hotel-detail.html"><img src="../asset/petualangan/Doraemon.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>petualangan</small>
						</figure>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="hotel-detail.html"><img src="../asset/petualangan/ferals.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>petualangan</small>
						</figure>
						<div class="wrapper" style="margin-top: -20px;">
							<h2><a href="hotel-detail.html">Rasuk</a></h2>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="hotel-detail.html"><img src="../asset/petualangan/jiwa petualang.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>petualangan</small>
						</figure>
						<div class="wrapper" style="margin-top: -20px;">
							<h2><a href="hotel-detail.html">Rasuk</a></h2>
