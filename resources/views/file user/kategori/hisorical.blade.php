...
<!-- Mirrored from www.ansonika.com/panagea/hotels-grid-isotope.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 17:53:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
	...
	<header class="header menu_fixed">
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li><span><a href="#0">Kategori</a></span>
					<ul>
						...
						<li>
							...
							<li><a href="/fantasi">Fantasi</a></li>
				...
				<li><span><a href="/tambah">Tambah</a></span>
				
				
				<li><span><a href="/profil">Profil
	...
	<main>
		...
		<section class="hero_in historical">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Historical</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
				...
				<ul class="clearfix">
					<li>
						<div class="switch-field">
							...
							<label for="popular">Terbaru</label>
				...
				<div class="row g-0 custom-search-input-2 inner">
					<div class="col-lg-4">
						<div class="form-group">
							<input class="form-control" type="text" placeholder="Apa yng akan anda cari...">
			...
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid">
						<figure>
							...
							<a href="hotel-detail.html"><img src="../asset/historical/Julie Garwood.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>historical</small>
						</figure>
						<div class="wrapper" style="margin-top: -20px;">
							<h2><a href="hotel-detail.html">Rasuk</a></h2>
							<h6>adinda</h6>
							<div class="cat_star" style="margin-left: 250px; margin-top:-30px;"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
							<br>
							<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
							<span class="price"><strong>05-06-2021</strong></span>
						</div>
						<ul>
							<li><i class="ti-eye"></i> 164 views</li>
							<li><div class="score"><span>Jumlah<em>halaman</em></span><strong>857</strong></div></li>
						</ul>
					</div>
				</div>
				<!-- /box_grid -->
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="hotel-detail.html"><img src="../asset/historical/the Broken Hours.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>historical</small>
						</figure>
						<div class="wrapper" style="margin-top: -20px;">
							<h2><a href="hotel-detail.html">Rasuk</a></h2>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="hotel-detail.html"><img src="../asset/historical/the Pioneers.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>historical</small>
						</figure>
						<div class="wrapper" style="margin-top: -20px;">
							<h2><a href="hotel-detail.html">Rasuk</a></h2>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="hotel-detail.html"><img src="../asset/historical/the Promise.jpeg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Lanjut baca</span></div></a>
							<small>historical</small>
						</figure>
						<div class="wrapper" style="margin-top: -20px;">
							<h2><a href="hotel-detail.html">Rasuk</a></h2>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid">
						...
						<ul>
							<li><i class="ti-eye"></i> 164 views</li>  v
							<li><div class="score"><span>Jumlah<em>halaman</em></span><strong>857</strong></div></li>
						</ul>
					</div>
				</div>
